// Array mit DOM-Eigenschaften um das Quiz zu erstellen.
...
data.forEach((item) => {
  ...
  item.choice.forEach((answer, index) => {
   
    let btn = document.createElement("button");
    btn.addEventListener("click", function () {
      if (item.choice[index] == item.answer) {
        btn.style.backgroundColor = "green";
       
      } else if(item.choice[index] != item.answer) {
